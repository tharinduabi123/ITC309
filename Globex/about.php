		...
		<div id="main" class="shell">
			...
			<div id="content">
				...
				<div class="post">
					...
					<h2>Developer</h2>
					<img src="images/anja.jpg" alt="Post Image" width="140" height="159" />
					<p>Anjana Dissanayake </p>
				...
				<div class="post">
					...
					<h1 align="center"><font color="blue">About The Project Developers</font></h1><br>
					<h2>Developer</h2>
					<img src="images/tharindu.jpg" alt="Post Image" width="140" height="159" />
					<p>Tharidu Abishek </p>
					<p>. <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<div class="post">
					<h2>Developer</h2>
					<img src="images/sanchith.jpg" alt="Post Image" width="140" height="159" />
					<p>Sanchit Mahajan </p>
					<p>. <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; Globex.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> Globex</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
