...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
                <img src="images/log1.png" alt="Post Image" height="120" width="260"/>
...
<!-- Begin Slider -->
				...
				<ul class="slider-items">
					<li>
						...
						<div class="slide-entry">
							<h2><span> US</span> Farming Tractor</h2>
					...
					<li>
						...
						<div class="slide-entry">
							<h4><span>US</span><span class="small"></span> &nbsp;Farming Tractor</h4>
					...
					<li>
						...
						<div class="slide-entry">
							<h3><span>US</span><span class="small"> </span>Super<span class="small"> Farming Tractor</span></h3>
						...
						<div class="slide-entry">
							<h3><span class="small"> Heavy</span>Tractor</h3>
					...
					<li>
						...
						<div class="slide-entry">
							<h4><span>Paddyfield</span>Master</h4>
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
    ...
    ?>
      ...
      <!-- Begin Products Slider -->
		...
		<div id="footer">
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About Globex</h2>
						<div class="box-entry">
							<img src="images/log1.png" alt="SomStore" width="160" height="80"/>
							<p>Agricultural machinery is machinery used in farming or other agriculture. There are many types of such equipment, from hand tools and power tools to tractors and the countless kinds of farm implements that they tow or operate. Diverse arrays of equipment are used in both organic and nonorganic farming. Especially since the advent of mechanised agriculture, agricultural machinery is an indispensable part of how the world is fed. </p>
							<div class="cl">&nbsp;</div>
						</div>
					</div>
					...
					<div class="box last-box">
						<h2>Categories</h2>
						<ul>
							<li><a href="#" title="Clothes">Tractor</a></li>
							<li><a href="#" title="Cleaning Material">Heavy Machine</a></li>
							<li><a href="#" title="Fizzi Drinks">Equipments</a></li>
							<li><a href="#" title="Food Stuff">US tractor</a></li>
						</ul>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p>&copy; Globex.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To Globex Online Equipments Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2021 Globex.com All rights reserved. The information contained in Globex.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of Globex.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
		...
		<div class="shout_box">
      <div class="header"> live Discussion of Globex <div class="close_btn">&nbsp;</div></div>
